...
export default function DashboardHeader({ company, activePage }: DashboardHeaderProps) {
    ...
    <>
      ...
      <nav className="nav-menu">
        <div className="nav-content">
          ...
          <button 
            className={`nav-button ${isActivePage('cms') ? 'active' : ''}`}
          ...
          <div style={{position: 'relative'}}>
            ...
            <div style={{position: 'fixed', top: '120px', left: '520px', background: 'rgba(30, 41, 59, 0.95)', backdropFilter: 'blur(24px)', border: '1px solid rgba(139, 92, 246, 0.3)', borderRadius: '12px', boxShadow: '0 25px 50px rgba(0, 0, 0, 0.4)', zIndex: 9999, minWidth: '180px', padding: '8px', opacity: financialDropdownOpen ? 1 : 0, visibility: financialDropdownOpen ? 'visible' : 'hidden', transform: financialDropdownOpen ? 'translateY(0) scale(1)' : 'translateY(-10px) scale(0.95)', transition: 'all 0.3s ease', transformOrigin: 'top left'}}>
          ...
          <div style={{position: 'relative'}}>
            ...
            <div style={{position: 'fixed', top: '120px', left: '600px', background: 'rgba(30, 41, 59, 0.95)', backdropFilter: 'blur(24px)', border: '1px solid rgba(139, 92, 246, 0.3)', borderRadius: '12px', boxShadow: '0 25px 50px rgba(0, 0, 0, 0.4)', zIndex: 9999, minWidth: '180px', padding: '8px', opacity: toolsDropdownOpen ? 1 : 0, visibility: toolsDropdownOpen ? 'visible' : 'hidden', transform: toolsDropdownOpen ? 'translateY(0) scale(1)' : 'translateY(-10px) scale(0.95)', transition: 'all 0.3s ease', transformOrigin: 'top left'}}>
          ...
          <div style={{position: 'relative'}}>
            ...
            <div style={{position: 'fixed', top: '120px', left: '680px', background: 'rgba(30, 41, 59, 0.95)', backdropFilter: 'blur(24px)', border: '1px solid rgba(139, 92, 246, 0.3)', borderRadius: '12px', boxShadow: '0 25px 50px rgba(0, 0, 0, 0.4)', zIndex: 9999, minWidth: '180px', padding: '8px', opacity: archivesDropdownOpen ? 1 : 0, visibility: archivesDropdownOpen ? 'visible' : 'hidden', transform: archivesDropdownOpen ? 'translateY(0) scale(1)' : 'translateY(-10px) scale(0.95)', transition: 'all 0.3s ease', transformOrigin: 'top left'}}>
